        ...
        <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
          <div class="card">
            <div class="card-body text-center">
              <img src="{{ asset(App::environment('production') ? '/public/uploads/accounts' : '/uploads/accounts') }}/{{ $applicant->image }}" alt="Charles Marnie B. Limpo" class="mb-3 border" width="192px" height="192px" style="border-radius: 50%;">
